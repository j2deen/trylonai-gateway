...
class ClassificationModel(BaseTransformerModel[AutoModelForSequenceClassification]):
    """
    Classification model wrapper for sequence classification tasks.
    """

    async def initialize(self) -> None:
        def blocking_init() -> Tuple[nn.Module, AutoTokenizer, bool]:
            try:
                ...
                return model_with_precision, tokenizer, use_float16
